...
<%@ page session="true" %>
	<form class="form-horizontal" role="form" method="post" action="<c:url value ='/menu/clothing_insert_register?CATEGORY_SEQ=4'/>">
		...
		<div class ="col-sm-11" style = "margin:2px">
			<p class="w3-right" style = "margin-left: 16px"><button class="w3-button w3-black" ><b>Register</b></button></p>
		</div> 
	</form>