...
<form class="form-horizontal" role="form" method="post" action="<c:url value ='/menu/etc/insert_comments_register?BOARD_SEQ=${resultData.BOARD_SEQ}&CATEGORY_SEQ=${resultData.CATEGORY_SEQ}'/>">
