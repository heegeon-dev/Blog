    ...
    <!-- Blog entry -->
      <div class="w3-container w3-white w3-margin w3-padding-large">
        ...
        <div class="w3-justify">
          <a href = "<c:url value = '/menu/clothing/edit?BOARD_SEQ=${resultData.BOARD_SEQ}'/>"><img src="<c:url value='/resources/images/${resultData.IMG_NAME}'/>" alt="Runway" style="width:100%" class="w3-padding-16"></a>
...
<!--               <div class="w3-col l10 m9"> -->
              ...
              <c:if test = "${inhog.BOARD_SEQ eq resultData.BOARD_SEQ}">
                ...
                <h4>${inhog.ID}  <a href = "<c:url value ='/menu/clothing/delete_comments_register?BOARD_SEQ=${resultData.BOARD_SEQ}&CATEGORY_SEQ=${resultData.CATEGORY_SEQ}&COMMENT_SEQ=${inhog.COMMENT_SEQ}'/>"><button class="w3-button w3-right w3-tiny w3-padding-small w3-white w3-border">x</button></a></h4>
                <p>${inhog.CONTENTS}</p>
              </c:if>
            </c:forEach>
            </c:forEach>
...
<form class="form-horizontal" role="form" method="post" action="<c:url value ='/menu/clothing/insert_comments_register?BOARD_SEQ=${resultData.BOARD_SEQ}&CATEGORY_SEQ=${resultData.CATEGORY_SEQ}&ID=${principalName}'/>">
