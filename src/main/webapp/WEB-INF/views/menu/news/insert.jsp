...
<%@ page session="true" %>
	...
	<form class="form-horizontal" role="form" method="post" action="<c:url value ='/menu/news_register?CATEGORY_SEQ=6'/>">
		...
		<div class="col-sm-9" style = "margin:2px">
			<textarea class="form-control" rows="1" name="file" placeholder = "파일을 불러오세요."></textarea>
		</div>  
		<div class ="col-sm-11" style = "margin:2px">
			<p class="w3-right" style = "margin-left: 16px"><button class="w3-button w3-black" type="sumbit"><b>Register</b></button></p>
		</div> 
	</form>